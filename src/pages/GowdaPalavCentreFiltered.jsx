...
const LUNCH_ITEMS = [
  ...
  { id: 'gp-lunch-chicken-kabab-full', name: 'Chicken Kabab / Chops (Full)', kannada: 'ಚಿಕನ್ (ಕಬಾಬ್)/(ಚಾಪ್ಸ್)', price: 139.99 },
  { id: 'gp-lunch-chicken-kabab-half', name: 'Chicken Kabab / Chops (Half)', kannada: 'ಚಿಕನ್ (ಕಬಾಬ್)/(ಚಾಪ್ಸ್)', price: 99.99 },
  { id: 'gp-lunch-chicken-leg', name: 'Chicken Leg Piece', kannada: 'ಚಿಕನ್ (ಲೆಗ್ ಪೀಸ್)', price: 89.99 },
  { id: 'gp-lunch-chicken-lollipop-full', name: 'Chicken Lollipop / Liver (Full)', kannada: 'ಚಿಕನ್ (ಲಾಲಿಪಾಪ್ / ಲಿವರ್)', price: 139.99 },
  { id: 'gp-lunch-chicken-lollipop-half', name: 'Chicken Lollipop / Liver (Half)', kannada: 'ಚಿಕನ್ (ಲಾಲಿಪಾಪ್ / ಲಿವರ್)', price: 99.99 },
